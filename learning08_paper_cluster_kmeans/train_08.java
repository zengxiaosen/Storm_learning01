 ...
 */
public class train_08 {


    private static final long serialVersionUID = 1L;
    public final static String SERIALIZABLE_PATH = "D:\\train_08.ser";
    //训练集的位置
    ...
    //分词器
    private transient Participle08 participle;
    private static train_08 trainInstance = new train_08();

    private static train_08 getInstance() {
        trainInstance = new train_08();
        //读取序列化在硬盘的本类对象
        FileInputStream fis;
        try {
            ...
            if (f.length() != 0) {
                ...
                trainInstance = (train_08) oos.readObject();
                trainInstance.participle = new IkParticiple08();
            } else {
                trainInstance = new train_08();
            }
        } catch (Exception e) {
    ...
    private train_08() {
        this.participle = new IkParticiple08();
    }
...
//计算各个类别的样本数
        ...
        for (String classKey : keySet) {
            Participle08 participle = new IkParticiple08();
...
//假如这个词在类别下所有文章中木有，那么给定个极小的值， 不影响计算
    ...
    public static void main(String[] args){
        train_08 mytrain = train_08.getInstance();
        mytrain.realTrain();
        //mytrain.printAll();
